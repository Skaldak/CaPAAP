...
class CapsuleLayer(nn.Module):
    def __init__(
        self, num_capsules, num_route_nodes, in_channels, out_channels, kernel_size=None, stride=None, num_iterations=3
    ):
...
class CapsuleNet(nn.Module):
    def __init__(self, num_classes=10):
        ...
        self.primary_capsules = CapsuleLayer(
            num_capsules=8, num_route_nodes=-1, in_channels=256, out_channels=32, kernel_size=3, stride=2
        )
        self.digit_capsules = CapsuleLayer(
            num_capsules=self.num_classes, num_route_nodes=32 * 5 * 5, in_channels=8, out_channels=16
        )
