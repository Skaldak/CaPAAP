...
class Dataset:
    def __init__(self, dataset, _batch_size):
        ...
        if dataset == "mnist":
            ...
            train_dataset = datasets.CIFAR10("/data/cifar", train=True, download=True, transform=data_transform)
            test_dataset = datasets.CIFAR10("/data/cifar", train=False, download=True, transform=data_transform)
