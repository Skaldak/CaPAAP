        ...
        for width in width_range:
            for prominence in prominence_range:
                for distance in distance_range:
                    ...
                    pred_counter = 0
                    gt_counter = 0
                    peaks = detect_peaks_in_batch(yhats, prominence=prominence, width=width, distance=distance)
                    ...
                    p, r, f1, rval = self.get_metrics(precision_counter, recall_counter, pred_counter, gt_counter)
                    if rval > max_rval:
                        max_rval = rval
