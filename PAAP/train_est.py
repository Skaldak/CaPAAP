...
def run(args):
    ...
    tr_dataset = NoisyCleanSet(
        ...
        stride=stride,
        pad=args.pad,
        acoustic_path=args.acoustic_train_path,
        ph_logits_path=args.ph_logits_train_path,
        **kwargs
    )
    ...
    if args.dset.valid:
        cv_dataset = NoisyCleanSet(
            args.dset.valid, acoustic_path=args.acoustic_valid_path, ph_logits_path=args.ph_logits_valid_path, **kwargs
        )
    ...
    if args.dset.test:
        tt_dataset = NoisyCleanSet(
            args.dset.test, acoustic_path=args.acoustic_test_path, ph_logits_path=args.ph_logits_test_path, **kwargs
        )
